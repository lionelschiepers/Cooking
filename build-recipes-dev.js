...
function generateRecipeHtml(mdFilePath, outputDir) {
  ...
  // Handle relative_url filter with proper paths (for dev, no baseurl)
  html = html.replace(
...
// Main execution
console.log('Generating static recipe pages for development...\n');

// Check if _recipes directory exists
if (!fs.existsSync(RECIPES_DIR)) {
  console.log('No _recipes directory found.');
  console.log('Run: npm run generate:recipes');
  process.exit(1);
}
...
console.log(
  `\n✅ Generated ${generatedCount} static recipe pages for development`,
);
